...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_de_la_vida

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_de_la_vida: ${OBJECTFILES}
...
${OBJECTDIR}/entrada.o: entrada.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/entrada.o entrada.c

${OBJECTDIR}/salida.o: salida.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/salida.o salida.c
